...
figwidth = 2.0 * nfilters
figlength = 2.0 * ntargets
...
for itarg in range(0, ntargets):
    ...
    for ifilt in filterlist:
        plt.subplot(ntargets, nfilters, counter)

        # grab the axes instance
        ax = fig.add_subplot(ntargets, nfilters, counter)
        #ax = fig.gca()
